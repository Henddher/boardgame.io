...
import { Client, createMoveDispatchers } from '../../src/client/client';
import { ProcessGameConfig } from '../../src/core/game';
import { Transport } from '../../src/client/transport/transport';
import { LocalTransport, Local } from '../../src/client/transport/local';
import {
  SocketIOTransport,
  SocketIO,
} from '../../src/client/transport/socketio';
import {
  update,
  sync,
  makeMove,
...
import * as Actions from '../../src/core/action-types';
import Debug from '../../src/client/debug/Debug.svelte';
import { error } from '../../src/core/logger';
import type { Game, LogEntry, State, SyncInfo } from '../../src/types';
import type { Operation } from 'rfc6902';
import type { TransportData } from '../../src/master/master';
